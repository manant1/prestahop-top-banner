...
{if $enabled}
	<div class="banner" style="height: {$height|escape:'htmlall':'UTF-8'}px; color: {$text_color|escape:'htmlall':'UTF-8'}; background: {$bg_color|escape:'htmlall':'UTF-8'}; display: flex;">
